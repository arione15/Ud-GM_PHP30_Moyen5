...
1. On filtre les livres selon certaines propriétés => donc on doit compare (`if`) les propriétés des livres parcourus (`foreach`) avec les valeurs mises en paramètre de la fonction
